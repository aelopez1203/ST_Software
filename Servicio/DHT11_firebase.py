...
file = open('AdminLogs/AdminLogTempHum_'+str(x)+'.txt', 'w', encoding='utf-8')
# Finaliza archivo admin_logs
file.close()

# Inicia edicion del archivo admin_logs
file = open('AdminLogs/AdminLogTempHum_'+str(x)+'.txt', 'a', encoding='utf-8')
...
# Print, para mostrar en consola los resultados de la ejejcuciòn
print('=================================================')
print('=         Proceso de adquisicion de datos       =')
print('=================================================')
print('\n')
...
while True:
 ...
 file.write('\n')
 file.write('\nInicio proceso Nº ' + str(Contador))
 file.write('\nFecha: '+str(fecha_actual))
 
 print('\n')
 print('Inicio proceso Nº ' + str(Contador))
 ...
 if r:
    ...
    print('Temperatura de: {0:0.1f}ºC Con Humedad de: {1:0.1f}%'.format(r[0], r[1]))
    ...
    print('Datos almacenados en Firebase: OK')
    ...
    print('Recoleccion y actualizacion de datos: OK')

    # Si ingresa datos a la nube, el proceso se realiza satisfactoriamente
    firebase.put('/recolecta_datos', 'OK','true')
    
    
    file.write('\nFin proceso Nº ' + str(Contador))
    file.write('\n')
    print('Fin proceso Nº ' + str(Contador))
    print('\n')
    file.close()
...
# Error al ingresar datos a la nube, el proceso se toma fallido
    ...
    file.write('\nFin proceso Nº ' + str(Contador))
    print('Fallo al obtener resultados')
    print('Fin proceso Nº ' + str(Contador))
    file.close()
